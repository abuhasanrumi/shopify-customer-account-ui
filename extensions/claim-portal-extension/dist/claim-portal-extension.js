...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/customer-account/hooks/storage.mjs
  function useStorage() {
    return useApi().storage;
  }

  // extensions/claim-portal-extension/src/MenuActionExtension.jsx
  ...
  function MenuActionExtension() {
    const { i18n, orderId: orderId2 } = useApi();
    const storage = useStorage();
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { to: `extension:/${orderId2}`, children: "File a claim" });
  }

  // extensions/claim-portal-extension/src/FullPageExtension.jsx
  ...
  function FullPageExtension() {
    var _a, _b;
    const { navigation, extension: extension2, i18n } = useApi();
    const [currentStep, setCurrentStep] = (0, import_react25.useState)(1);
    console.log("navigation", (_b = (_a = navigation == null ? void 0 : navigation.currentEntry) == null ? void 0 : _a.url) == null ? void 0 : _b.replace("'extension:/shopify/Order/", ""));
    const [checkedProducts, setCheckedProducts] = (0, import_react25.useState)([]);
    const [shippingIssue, setShippingIssue] = (0, import_react25.useState)("");
    const [issueDetails, setIssueDetails] = (0, import_react25.useState)({
      issue: "",
      links: []
    });
    const [receiveOption, setReceiveOption] = (0, import_react25.useState)("");
      ...
      Page2,
      {
        ...
        secondaryAction: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          Button2,
          {
            ...
            onPress: () => navigation.navigate(`shopify:customer-account/orders/${orderId}`)
          }
        ),
        children: [
          currentStep == 1 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Card2, { padding: true, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "large", children: "Select faulty products" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "loose" }),
              [1, 2, 3].map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                  Grid2,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { spacing: "small500", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "base", children: "Beard Gains - Valhalla Vikings Beard Cutting" }),
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "extraSmall", appearance: "accent", children: "Variant: 90ml/3oz" })
                      ] }) }),
                      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "base", children: "$62.38" }) })
                    ]
                  }
                ),
          ...
          currentStep == 2 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Card2, { padding: true, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "large", children: "Select an issue" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "loose" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                ChoiceList2,
                {
                  ...
                  children: ["Damaged", "Lost", "Stolen"].map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                      Choice2,
                      {
                        secondaryContent: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "arrowRight" }),
                        id: item.toLowerCase(),
                        children: item
                      }
                    ),
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "small200" })
                  ] }, index))
                }
              )
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(InlineLayout2, { columns: ["35%", "fill"], spacing: "base", children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                Button2,
                {
                  kind: "secondary",
          ...
          currentStep == 3 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Card2, { padding: true, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "medium", children: "Explain your issue *" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "small300" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                TextField2,
                {
                  required: true,
                  multiline: "10",
                  onChange: (value) => setIssueDetails(__spreadProps(__spreadValues({}, issueDetails), {
                    issue: value
                  }))
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "loose" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "medium", children: "Add image links (separated by comma)" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "small300" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                TextField2,
                {
                  ...
                  onChange: (value) => {
                    ...
                    setIssueDetails(__spreadProps(__spreadValues({}, issueDetails), {
                      links: linksArray
                    }));
                  }
                }
          ...
          currentStep == 4 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Card2, { padding: true, children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "large", children: "What would you like to receive?" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "loose" }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                ChoiceList2,
                {
                  ...
                  children: ["Refund", "Reorder"].map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                      Choice2,
                      {
                        secondaryContent: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "arrowRight" }),
...
//# sourceMappingURL=claim-portal-extension.js.map
